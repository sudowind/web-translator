...
describe('翻译响应解析', () => {
  ...
  it.each([
    ...
    ['{"translations":[{"id":"b1","translation":"你好"}]}', 'TRANSLATION_SCHEMA_INVALID'],
    ['{"translations":[{"id":"b1","text":{"zh":"你好"}}]}', 'TRANSLATION_SCHEMA_INVALID'],
    ['{"translations":[{"id":"b1","text":null}]}', 'TRANSLATION_SCHEMA_INVALID'],
    ['{"translations":[{"id":1,"text":"你好"}]}', 'TRANSLATION_SCHEMA_INVALID'],
    ['{"translations":[],"blocks":[]}', 'TRANSLATION_SCHEMA_INVALID'],
    ['[{"id":"b1","text":"你好"}]', 'TRANSLATION_SCHEMA_INVALID'],
